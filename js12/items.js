const templateCart = document.querySelector('.card').innerHTML;
const cartData = [];
...
document.querySelector('.conteiner2').addEventListener('mouseover', (ev) => {
    if(ev.target.className == 'dataProduct'){
